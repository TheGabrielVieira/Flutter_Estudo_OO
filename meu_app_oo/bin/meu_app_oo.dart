...
void main(List<String> arguments) {
  ...
  var pessoaFisica1 = PessoaFisica("Gabriel", "Rua2", "65165165165");
  print(pessoaFisica1);

  var pessoaJuridica1 = PessoaJuridica("Empresa 1", "Rua 3", "16516516561", tipoNotificacao: TipoNotificacao.EMAIL);
